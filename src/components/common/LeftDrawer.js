...
const LeftDrawer = (props) => {
  ...
  const user = authenticationService.currentUser.subscribe((x) => x);

  const drawerContent = () => (
    <div>
      <div className={classes.logo}>Cloud Marketplace</div>
      <div
      ...
      >
        ...
        />
        <span className={classes.avatarSpan}>{user.userName}</span>
      </div>
